...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/LOTNS_Server_Setup.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/LOTNS_Server_Setup.git
...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/OpenSSL.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/OpenSSL.git
...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/DNSControl.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/DNSControl.git
...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/About_Soracloud.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/About_Soracloud.git
...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraCloud_Themes.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraCloud_Themes.git
...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraAPI.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraAPI.git
...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraBlog.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraBlog.git
...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraFonts.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraFonts.git
...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/LOTNS_Web_Server.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/LOTNS_Web_Server.git
...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/LOTNS.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/LOTNS.git
...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/UnOrdinary.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/UnOrdinary.git
...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraID.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraID.git
...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraID_UnProtected.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraID_UnProtected.git
...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraStatus.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraStatus.git
...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraStatus_Logs.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraStatus_Logs.git
...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraStatus_Private.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/SoraStatus_Private.git
...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/ReWrites.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/ReWrites.git
...
git remote set-url --delete --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/AeonQuake.git
...
git remote set-url --add --push origin https://IzumiSenaSora:$GITHUB_TOKEN@github.com/IzumiSenaSora/AeonQuake.git
